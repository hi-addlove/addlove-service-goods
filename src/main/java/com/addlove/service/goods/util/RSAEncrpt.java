...
public class RSAEncrpt {
     ...
     * @throws Exception
     */
    public static String encrypt(String input, String eKey, String nKey) throws Exception {
        byte[] bInput = input.getBytes("UTF8");
        Cipher cipher = Cipher.getInstance("RSA/NONE/PKCS1Padding", "BC");
        KeyFactory keyFactory = KeyFactory.getInstance("RSA", "BC");
        RSAPublicKeySpec pubKeySpec = new RSAPublicKeySpec(new BigInteger(nKey), new BigInteger(eKey));
        ...
        return ByteAndStrTransUtil.toHex(cipherText);
    }
     ...
     * @throws Exception
     */
    public static String decrypt(String input, String dKey, String nKey) throws Exception {
        byte[] bInput = ByteAndStrTransUtil.hexStr2Bytes(input);
        Cipher cipher = Cipher.getInstance("RSA/NONE/PKCS1Padding", "BC");
        KeyFactory keyFactory = KeyFactory.getInstance("RSA", "BC");
        RSAPrivateKeySpec privKeySpec = new RSAPrivateKeySpec(new BigInteger(nKey), new BigInteger(dKey));
        ...
        for (int i = 0; i < GroupLength; i++) {
            System.arraycopy(plainList.get(i), 0, plainText, i * MaxLength, plainList.get(i).length);
        }
        return ByteAndStrTransUtil.toString(plainText);
    }
   ...
   /* public static void main(String[] args) throws Exception {
        ...
        String enc = RSAEncrpt.encrypt(input, e, n);
        
        System.out.println("enc : " + enc);
        System.out.println("dec : " + RSAEncrpt.decrypt(enc, d, n));
    }*/
}